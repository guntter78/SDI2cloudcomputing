...
# Toestaan van verkeer tussen Proxmox en Docker netwerk 192.168.5.0/24
sudo iptables -A FORWARD -s 10.24.36.0/24 -d 192.168.5.0/24 -j ACCEPT
sudo iptables -A FORWARD -s 192.168.5.0/24 -d 10.24.36.0/24 -j ACCEPT

# Toestaan van verkeer tussen Proxmox en Docker netwerk 192.168.6.0/24
...
sudo iptables -A FORWARD -s 192.168.6.0/24 -j ACCEPT
sudo iptables -A FORWARD -d 192.168.6.0/24 -j ACCEPT
